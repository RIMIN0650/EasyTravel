	...
	<div id="wrap" class="bg-warning">
		...
		<div id="post-box">
			...
			<div class="d-flex justify-content-center">
				...
				<div>
					<select class="select-type selectpicker" id="selectRoom">
							  <option value="0" selected>관 선택</option>
							  <option value="1">관 택</option>
							  <option value="2">관 선</option>
					</select>
					<button type="button" class="btn btn-success">정렬</button>
				</div>	
			</div>
